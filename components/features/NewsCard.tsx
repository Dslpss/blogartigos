  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <span className="px-3 py-1 bg-surface text-[9px] font-black uppercase text-highlight tracking-[0.2em] rounded-full border border-border group-hover:border-highlight/30 transition-colors">
          {category}
        </span>
      ...
      <p className="text-sm text-secondary mb-6 line-clamp-3 font-medium leading-relaxed">
        {excerpt}
      </p>
      ...
      <div className="mt-auto pt-6 border-t border-border flex items-center justify-between">
        <Link 
          href={`/news/${slug || id}`}
          className="text-[10px] font-black uppercase tracking-widest text-primary hover:text-highlight flex items-center gap-2 group/btn"
        >
